...
void new_number(gk_string *gstr, unsigned long val)
{
		set_number(forminfo_of(gstr),val);
}

void new_case(gk_string *gstr, unsigned long val)
{
		add_case(forminfo_of(gstr),val);
}


void new_tense(gk_string *gstr, unsigned long val)
{
		set_tense(forminfo_of(gstr),val);
}


void new_voice(gk_string *gstr, unsigned long val)
{
...
void new_mood(gk_string *gstr, unsigned long val)
{
...
void new_degree(gk_string *gstr, unsigned long val)
{
		set_degree(forminfo_of(gstr),val);
}


void new_gender(gk_string *gstr, unsigned long val)
{
		add_gender(forminfo_of(gstr),val);
}


void new_dialect(gk_string *gstr, unsigned long val)
{
		add_dialect(gstr,(Dialect)val);
}


void new_region(gk_string *gstr, unsigned long val)
{
		add_geogregion(gstr,(GeogRegion)val);
}


void new_morphflags(gk_string *gstr, unsigned long val)
{
...
void new_stemtype(gk_string *gstr, unsigned long val)
{
		set_stemtype(gstr,(Stemtype)val);
}


void new_domain(gk_string *gstr, unsigned long val)
{
...
void new_derivtype(gk_string *gstr, unsigned long val)
{
